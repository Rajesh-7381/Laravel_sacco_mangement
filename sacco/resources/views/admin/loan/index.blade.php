              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {{ $value->getLoanPlan->months .'['. $value->getLoanPlan->intrest_percentage .'%'.$value->getLoanPlan->penalty_rate.']' }}
                    </td>
                    ...
                    <td>
                      ...
                      <a onclick="return confirm('Are you sure you want to delete it?')" class="btn btn-danger" href="{{ url('admin/loan/delete/' . $value->id) }}"><i class="bi bi-trash"></i></a>
                      </td>
