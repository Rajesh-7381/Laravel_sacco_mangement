        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{url('admin/loan_plans/edit/'.$getRecord->id)}}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input 
                            ...
                            maxlength="10" required  value="{{$getRecord->months}}"
                        >
                    </div>
                    </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input 
                            ...
                            oninput="javascript:this.value=this.value.replace(/[^0-9]/g,''); if(this.value.length > this.maxLength) this.value=this.value.slice(0,this.maxLength);" 
                            maxlength="10" required  value="{{$getRecord->intrest_percentage}}"
                        >
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="penalty_rate" class="col-sm-2 col-form-label">Penalty Rate </label>
                    <div class="col-sm-10">
                        <input 
                            type="tel" 
                            class="form-control" 
                            ...
                            id="penalty_rate" 
                            oninput="javascript:this.value=this.value.replace(/[^0-9]/g,''); if(this.value.length > this.maxLength) this.value=this.value.slice(0,this.maxLength);" 
                            maxlength="10" required  value="{{$getRecord->penalty_rate}}"
                        >
                    </div>
                </div>
