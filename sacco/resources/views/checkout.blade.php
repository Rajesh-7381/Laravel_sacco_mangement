...
<head>
    ...
    <title>Bootstrap Table with Product Images</title>
</head>
<body>
    <div class="container">
        <h1>Bootstrap Table with Product Images</h1>
        <table class="table table-bordered">
            ...
            <tfoot>
                <tr>
                    <td style="text-align: right">total $6</td>
                </tr>
                <tr>
                    <td colspan="5" style="text-align: right">
                    <form action="/session" method="post">
                        <a href="" class="btn btn-danger">continue shoping</a>
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <input type="hidden" name="total" value="6">
                        <input type="hidden" name="productname" value="asus vivobook">

                        <button class="btn btn-success" type="submit" id="submit">checkout</button>
